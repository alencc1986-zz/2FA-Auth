...
function Backup () {
    clear
    echo "================================"
    echo "2FA-Auth ${VERSION} // Config backup"
    echo "================================"
    echo

    case $1 in
         Create) if [[ ! -f ${TokenFile} ]]; then
                     echo "FAIL! No token was found!"
                     ...
                     if [[ ! -f $HOME/${BackupFile} ]]; then
                         ...
                         Overwrite "Would you like to overwrite the backup file?" \
                                   ...
                                   "Okay! Keeping your previous backup file!"
                     fi
                 fi ;;
        ...
        Restore) echo "Restoring your config from '$HOME/${BackupFile}'..."
                 if [[ -f $HOME/${BackupFile} ]]; then
                     ...
                     echo "you can replace a token that is working perfectly well by a token"
                     echo "which isn't associated anymore with your logins."
                     ...
                     Overwrite "Would you like to continue and overwrite your tokens/config?" \
                               ...
                               "Okay! Keeping your previous files!"
